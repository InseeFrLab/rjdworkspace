...
- replace, remove or add series in a workspace (`remove_sa_item()`, `remove_all_sa_item()`, `replace_sa_item()`, `add_new_sa_item()`);  
...
```{r fr-gh-installation, eval = FALSE}
...
```{r en-gh-installation, eval = FALSE}
